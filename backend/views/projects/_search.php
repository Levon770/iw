<?php $form=$this->beginWidget('bootstrap.widgets.TbActiveForm',array(
	...
	'method'=>'get',
		...
		<?php echo $form->textAreaRow($model,'descam',array('rows'=>6, 'cols'=>50, 'class'=>'span8')); ?>

		<?php echo $form->textAreaRow($model,'descen',array('rows'=>6, 'cols'=>50, 'class'=>'span8')); ?>

		<?php echo $form->textAreaRow($model,'teaseram',array('rows'=>6, 'cols'=>50, 'class'=>'span8')); ?>

		<?php echo $form->textAreaRow($model,'teaseren',array('rows'=>6, 'cols'=>50, 'class'=>'span8')); ?>
