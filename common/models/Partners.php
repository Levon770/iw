...
class Partners extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('titleam, link, image, type', 'required'),
			array('titleam, titleen, link, image', 'length', 'max'=>250),
			// The following rule is used by search().
			// Please remove those attributes that should not be searched.
			array('id, titleam, titleen, link, image, type', 'safe', 'on'=>'search'),
		);
	}
