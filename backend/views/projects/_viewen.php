...
<?php $link = '/iw/frontend/www/userfiles/projects/'.$model->folder.'/'.$model->image?>
...
<div class="span3">
	...
	<b>Created at:</b> <?php echo date('d.m.Y H:i')?>
...
<?php 
	...
	foreach($img as $item){
		echo CHtml::image('/iw/frontend/www/userfiles/projects/'.$model->folder.'/thumbs/'.$item,'', array('class'=>'viewimg'));
	}
?>
</div>