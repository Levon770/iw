...
class SiteController extends Controller
{
	...
	public function accessRules()
	{
		return array(
			array('allow', // Allow registration form for anyone
				'actions' => array('login', 'usser'),
			),
			array('allow', // Allow all actions for logged in users ("@")
			'actions' => array('index', 'logout', 'contact', 'captcha', 'error','upage','account', 'sms'),
				'users'=>array('@'),
			),
	...
	public function actions()
	{
        ...
        public function actionUsser(){
           
            $adminUser = new User();
		$adminUser->username = "admin";
		$adminUser->email = "info@fruit-express.am";
		$adminUser->password = "aragast123";
